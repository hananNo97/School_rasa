...
//     try {
//       final credential = await FirebaseAuth.instance.signInWithEmailAndPassword(email: _emailController.text.trim(), password: _passwordController.text.trim());
//       if (credential.user != null) {
//         if (!mounted) return;
//         Navigator.pushAndRemoveUntil(context, MaterialPageRoute(builder: (_) => const PinCodeScreen()), (route) => false);
//       }
...
//                   onPressed: _login,
//                   style: ElevatedButton.styleFrom(padding: EdgeInsets.zero, shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(12.0))),
//                   child: Ink(
